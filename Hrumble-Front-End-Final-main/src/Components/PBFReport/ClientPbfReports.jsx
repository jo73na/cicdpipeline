...
const  ClientPbfReports = ({csvlink,text,openCustompopup,chartlabel,chart1,chart2,chart3,chart4,chart5,filter,setFilter}) =>{   

      console.log("text",text)
 
     const [lable,setLable]=useState(["Sun","Mon","Thu","Wed","Thu","Fri","Sat"])

   const {clientReports,fetchstatus,range,date}=useContext(PBFContext)
    ...
    //   },
        {
          ...
          type: 'column',
          data: clientReports.ClientSubmission
      ...
      },
      {
        ...
        type: 'area',
        data: clientReports?.ClientScreenReject
...
export default ClientPbfReports;