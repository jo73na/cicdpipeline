...
const AccountViewpage = () => {
    const {ftechAccountSingle,accountSingle} = useContext(SalesandMargettingContext);
...
//     {title:'Date posted:', icon:'fa-solid fa-clock', subtitle:"7th May, 2024"},
...
function  PostComment(){
    return(
        <ul className="post-comment d-flex mt-1">
              <li>
                <label className="me-3 fs-1"><a href={accountSingle?.website_url} target='_blank'><i class="fa-brands fa-google"></i></a></label>
            </li>
            <li>
                <label className="me-3 fs-1"><a  href={accountSingle?.linkedin_url} target='_blank'><i class="fa-brands fa-linkedin-in"></i></a></label>
            </li>
            <li>
                <label className="me-3 fs-1"><a  href={accountSingle?.facebook_url} target='_blank'><i class="fa-brands fa-facebook-f"></i></a></label>
            </li>
            <li>
                <label className="me-3 fs-1"><a  href={accountSingle?.twitter_url} target='_blank'><i class="fa-brands fa-twitter"></i></a></label>
            </li>
  ...
  return (
    ...
    <h4 className="heading mb-0"><i className="fa-solid fa-chevron-left"
     ...
     }></i > {`Account/${accountSingle?.account_name}`}</h4>
        ...
        <div className="col-xl-12">
                <div className="card">
                    ...
                    <div className="d-flex align-items-center g-5">
                                                        ...
                                                        <img src={accountSingle?.logo_url} className="avatar avatar-xl" alt="" />
                                                        <div className=" cat-name"
                                                         style ={{
                                                            marginLeft: "8px"
                                                         }}>
													<h3 className="text-primary">{accountSingle?.name}</h3>
                                                        ...
                                                        <span className={`badge light border-0 badge-success`} style={{
                                                                ...
                                                                top: "26px",
                                                                position: "absolute"
                                                        }}>{accountSingle?.company_stage}</span>
                                                 
                                                         
                                                    </div>
                    </div>
                    <div className="profile-skills  p-3">
													<h4 className="text-primary mb-2">Industry</h4>
													 <Link to="/app-profile" className="btn btn-primary light btn-xs mb-1 me-1"> Professional Training and Coaching</Link>

                                                    {/* {jobSingle?.skils?.map((e,i)=>
													<Link key={i} to="/app-profile" className="btn btn-primary light btn-xs mb-1 me-1"> {e}</Link>
                                                    )}            */}
                                                ...
                                                <div className="profile-skills  p-3">
													<h4 className="text-primary mb-2">Technolgy Used</h4>
			

                                                    {accountSingle?.technology_names?.map((e,i)=>
													<Link key={i} to="/app-profile" className="btn btn-primary light btn-xs mb-1 me-1"> {e}</Link>
                                                    )}           
                    ...
                    <div className="profile-about-me p-3">
												 <div className="pt-4 border-bottom-1 pb-3">
														<h4 className="text-primary">Description</h4> 
														 {accountSingle?.short_description}
											 </div> 
												</div>
