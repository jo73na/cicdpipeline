...
import { Button, Drawer, Pagination, Switch,  } from 'antd';
...
const Contacts=()=>{
  ...
  const {paginationcontact,setPaginationcontact,contactLinkDrawer,setcontactlinkDrawer,handleViewContact,ViewContactDrawer,ViewContactPopup,AddContactPopup,AddContactDrawer,contacts,AddCompanyPopup,Loading,AddCompanyDrawer,fethContacts,}=useContext(SalesandMargettingContext)
  const navigate=useNavigate()
                    ...
                    <Tab.Container defaultActiveKey={'Grid'} >
                        <div className="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <p className='me-2'> Email Exists :</p><Switch className='me-4' defaultChecked />
