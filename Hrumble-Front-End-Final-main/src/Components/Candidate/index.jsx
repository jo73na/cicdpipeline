...
const Candidates = () => {
  ...
  const { handleSerchcandidatedataFetch, skill, location } =
      ...
      <ul className="post-comment d-flex mt-1">
        <li>
          <label className="me-3">
            <Link to={"#"}>
              <i class="fa-solid fa-briefcase me-2"></i> {item.to_exp_from || 0}
              y {Number(item.to_exp_to) < 12 ? item.to_exp_to : 0}m
            </Link>
          </label>
        </li>
        <li>
        ...
        {Allcandidates?.length < 1 ? (
          ...
          <div className="row">
              ...
              <Tab.Container defaultActiveKey={"Grid"}>
                <div className="d-flex justify-content-between align-items-center mb-4">
                  ...
                  <div className="d_f g_5 a_i_c">
                    <button
                      onClick={() => setAllcandidates([])}
                      className="btn btn-info btn-sm"
                    >
                      {" "}
                      <i class="fa-solid fa-magnifying-glass me-1"></i> Back To
                      Search
                    </button>

                    <p className="m_r_30 d_n_sm">
                      {" "}
                      Total Candidates :
                      <span
                        className=""
                                        ...
                                        <>
                                          ...
                                          >
                                            <label className="search-main-gap2">
                                              <Checkbox
                                                onChange={handleskillmanitory}
                                                defaultChecked={skill_required}
                                              />
                                              &nbsp; Mark all Skills as
                                              mandatory{" "}
                                            </label>
                                          ...
                                          >
                                            <Input
                                              placeholder="Enter Keywords like name ,email ,phone no., skills, designation and company"
                                              allowClear
                                            />
                                          </Form.Item>
                                          <label
                                            className="search-main-gap "
                                            style={{
                                              marginTop: "-25px",
                                              marginBottom: "50px",
                                            }}
                                          >
                                            <Checkbox />
                                            &nbsp; Mark all keywords as
                                            mandatory
                                          </label>
                                          <Form.Item
                                            label="Experience"
                                            className="search-main-gap2"
                                          >
            ...
            <Checkbox>Exclude candidates who have mentioned Anywhere in...</Checkbox> */}
                                          ...
                                          <Form.Item
                                            label="Preffered Location of Candidate"
                                    ...
                                    >
                                      ...
                                      <Accordion.Collapse eventKey="2">
                                        <>
                                          ...
                                          <Form.Item
                                            label="Notice Period/ Availability of joining"
                                            name="notice period"
                                          >
                                            <Select>
                                    ...
                                    >
                                      ...
                                      <Accordion.Collapse eventKey="3">
                                        <>
                                          ...
                                          <Form.Item
                                            label="Showing Candidates Seeking"
                                            name="empStatus"
                                          >
                                  ...
                                  <div className="d-flex justify-content-between">
                                    ...
                                    <div>
                                      ...
                                      <button
                                        ...
                                        onClick={() =>
                                          handleOpenDrawerassign(item?._id)
                                        }
                                      >
                                        {" "}
                                        + Assign To
