...
const SearchCandidate = ({ value, title }) => {
  ...
  return (
    <div className={`m_10 ${title && "card p_40"}`}>
      ...
      <div></div>
      <Form layout="vertical" form={form} onFinish={hadleSerchfinish}>
        ...
        <div className="col_2 m_t_30">
          <div>
            {/* <Form.Item label="Name" name="name">
              <Input placeholder="Enter First or Last Name" allowClear />
            </Form.Item>
          ...
          phone_no"
            >
              <Input placeholder="Enter Phone No." allowClear />
            </Form.Item> */}
        ...
        >
          <div>
            ...
            <label className="search-main-gap m_t_1">
              <Checkbox />
        ...
        <div className="col_2 m_t_1">
          ...
          >
            <Select showSearch options={locationsdata} allowClear />
