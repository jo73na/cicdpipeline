...
export default function BasicDetailEdit({ info}) { 
   const[value,setValue]=useState("")
    const [form] = useForm();
    
    const {candidateSingle,handleEditEmployeeDetail,skill}=useContext(CandidateContext)
 ...
 const onSubmit=(values)=>{
  ...
  return (
    ...
    layout="vertical">
      ...
      <div className="col_2 g_20 m_t_10  col_1_sm g_5_sm">
        <Form.Item
          label="First Name"
          name="first_name"
