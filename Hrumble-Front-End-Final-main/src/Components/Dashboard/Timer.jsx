...
const EmployeeTimeTracker = () => {
  ...
  return (
    ...
    <Card.Header className="card-header flex-wrap border-0">
        ...
        {isActive !== true ? (
            <button className="btn btn-primary btn-sm ms-2" onClick={handleStartPause}>
                Log In
            </button>
        ) : (
            <>
    ...
    <div className="card-body py-0">
        ...
        <div className="row mt-1 d-flex justify-content-between">
            <div className="col-xl-6 col-lg-6 col-sm-4">
            ...
            <div className="col-xl-6 col-lg-6 col-sm-4">
                <div className="card text-center">
                    <div className="card-body p-2">
                        ...
                        <h4 className="mb-0">
                            <p className="text-primary">{formatTime(totalBreakTime)}</p>
                        </h4>
                    </div>
                </div>
            </div>
        ...
        <Modal
            ...
            cancelButtonProps={{ style: { display: "none" } }}
        >
            <MailSend handlesend={handlesend} />
        </Modal>
    </div>
</div>
