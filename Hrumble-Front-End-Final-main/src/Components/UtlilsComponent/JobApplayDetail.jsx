...
// export default JobApplayDetail
...
const JobApplayDetail = ({id}) => {
  ...
  const aboutme = [
    ...
    {title:'Company Name', icon:'fa-solid fa-city', subtitle:jobSingle?.client_id && jobSingle?.client_id[0]?.name},
...
function  PostComment(){
    return(
        <ul className="post-comment d-flex mt-1">
              <li>
                <label className="me-3"><Link to={"#"}><i className=" fa-solid  fa-person-dress me-2"></i>{jobSingle?.client_id &&jobSingle?.client_id[0]?.name}</Link></label>
            </li>
            <li>
                ...
                <div className="card">
                    ...
                    <div className=" text-center g-5">
													...
													<h4 className="text-primary">
                                                        Technoladders | Full Time
                                                    </h4>

                         <h1
                          style={{
                             fontWeight:900
                          }}>{jobSingle?.job_title}</h1>

                                                       <div
                                                        className='d_f g_30 j_c_c'>
                                                       <button className='btn  btn-info'>REFER A FRIEND</button>
                                                       <button className='btn btn-primary'
                                                        onClick ={
                                                             ()=>{
                                                                navigate(`/applaycandidate/${id}`)
                                                             }
