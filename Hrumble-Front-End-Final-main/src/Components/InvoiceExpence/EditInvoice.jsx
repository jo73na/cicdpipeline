...
const EditInvoice = () => {
   const {editInvoice,handlesendInvoice,expence,fethSelect,clientSelect,fetchcontact,clientSent}=useContext(InvoiceExpenceContext)
 ...
 useEffect(() => {
  ...
  const handleopenModel =()=>{
   ...
   useEffect(() => {
       ...
       form.setFieldsValue({
        client_id :editInvoice?.client_id?._id,
        order_number:editInvoice?.order_number,
        subject:editInvoice?.subject,
        terms:editInvoice?.terms,
        invoice_number:editInvoice?.invoice_number
       })
       editInvoice?.tableData?.length>0 && setTableData(
        editInvoice?.tableData
        )
  ...
  return (
    ...
    <p className='heading_text'><LeftOutlined className='back' onClick={()=>navigate(-1)}/>Edit Invoice</p>
 ...
 {/*          
     ...
     <Select
      ...
      <div className='col_2 m_t_10'>
       ...
       >
         ...
         <button className="btn btn-info btn-sm">Save as Draft</button>
         <div className='d_f'>
         <button className="btn btn-primary btn-sm" type='primary'
          htmlType="submit"
          style={{
           borderRadius: '5px'
          }} >{saveSelect}</button>
     ...
     >
       ...
       {/* {
        ...
        <button type="primary" className='btn btn-primary btn-sm' onClick={handleopenModel}>Save</button>
        </div>
