...
function AiForm({ id, resume, job_description, onAnalysisComplete }) {
  ...
  const systemInstruction = `Consider you are a resume validator; Go through entire pdf file and provide complete resume evaluation for the given job description. Give the resumes a score of 100 by categorizing by below metrics. Category Weightage Skills Match 40 Experience Match 20 Responsibilities 20 Certifications 5 Keyword Match 15 Detailed scoring breakdown results in a table view Avoid Recommendations for Improvement instead add the summary of the report generated (if, job description key value is not align with resume reduce the mark for that, if no key value is matched , make or give zero mark. Key value or data is important. Never assume,compare the each value and data to allocate the mark) , never give me the examples and assumption values. Important : " Evaluate the candidate for the given job description by making  a strict and high level  screener through   line by line check and analyse it with the job description and provide more accurate result" .Give me the Detailed summay of the resume content , Detailed and key highlights area in  resume evaluation, Detail  summary report. Also mention pros and cons of the applicant with the given job detail.  Not to provide any extra details apart from the asked details.Be precise. This is the official document so provide only requested details`;
