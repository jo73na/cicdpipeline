...
const AddTeam = () => {
     ...
     const {onFinishTeam,onClose,buttonLodaing,FetcTeamAdd,users}=useContext(GoalContext)

     const handlefinish =(values)=>{
        onFinishTeam(values,form)
     }
      useEffect(()=>{
          FetcTeamAdd()
      },[])
  return (
    ...
    <Form.Item
     ...
     name="team_leader" 
     label="Team Leader"
     rules={[{ required: true, message: 'Please Select Team Name' }]}
   >
